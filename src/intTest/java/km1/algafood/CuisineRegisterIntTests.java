...
public class CuisineRegisterIntTests {
  ...
  void shouldThrowCuisineNotFound_whenTryFetchValidCuisine() {
    assertThrows(CuisineNotFountException.class, () -> underTest.tryFetch(INVALID_ID));
  }
  ...
  void shouldThrowCuisineNotFound_whenTryRemoveUnregisteredCuisine() {
    assertThrows(CuisineNotFountException.class, () -> underTest.retryRemoveNVALID_ID));
  }
  ...
  void shouldRemoveCuisine_whenTryRemoveValidCuisine() {
    ...
    assertThrows(CuisineNotFountException.class, () -> underTest.tryFetch(WITHOUT_DEPENDENTS_ID));
  }
